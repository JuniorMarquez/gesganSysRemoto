...
var numero = $scope.animales.length;
 ...
 $scope.totalHembrasJovenes=totalHembrasJovenes;
    ...
    $http.get('http://18.218.43.203:1337/grupo/?idUsuario='+MyService.data.idUsuario).then(function (resp2) {
...
$scope.getGraficoPrincipal =function(){
      $http.get('http://18.218.43.203:1337/ordeno/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
