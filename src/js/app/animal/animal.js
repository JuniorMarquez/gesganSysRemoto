...
$scope.openPeso = function (item) {
  ...
  $scope.selectItem = function(item){    
    ...
    $http.get('http://52.33.127.122:1337/animal/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
     ...
     $http.get('http://52.33.127.122:1337/peso/?idAnimal='+identificador).then(function (resp) {
  ...
  $scope.deleteAnimal = function(animal){
    $http.delete('http://52.33.127.122:1337/animal/'+animal.id , animal)
    $scope.items.splice($scope.items.indexOf(item), 1);
  ...
  $scope.doneEditingGrupo = function(item){
    ...
    if (MyService.data.idenGen){
      $http.put('http://52.33.127.122:1337/grupo/'+MyService.data.idenGen, grupoAct)
    }
    else {
      $http.post('http://52.33.127.122:1337/grupo/', grupoAct)
    }
    // $http.get('http://52.33.127.122:1337/grupo/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
    //   $scope.groups = resp.data.results;
    // });
...
// $http.get('http://52.33.127.122:1337/animal/').then(function (resp) {
...
//     $http.post('http://52.33.127.122:1337/peso/' ,pesoInicial);
...
animalAct.existente=true;
    ...
    if (MyService.data.idenAnimal){
      $scope.pop4();
      $http.put('http://52.33.127.122:1337/animal/'+MyService.data.idenAnimal , animalAct)
    }
    else {
      $scope.pop3();;
      $http.post('http://52.33.127.122:1337/animal/', animalAct)
    }
    $http.get('http://52.33.127.122:1337/grupo/?idUsuario='+MyService.data.idUsuario).then(function (resp) {
      $scope.groups = resp.data.results;
    });
